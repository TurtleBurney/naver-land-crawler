class Household:
    ...
    def __str__(self) -> str:
        return f"<building_dong : {self.building_dong}, floor : {self.floor}, direction : {self.direction}, supply_area : {self.supply_area}, private_area : {self.private_area}, url : {self.household_url}>"
